import ResetPasswordConfirmationForm from "../sections/ResetPasswordConfirmationForm";
import SimpleNavbar from "../sections/SimpleNavbar";

const ResetPasswordConfirmationPhone = () => {
  return (
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-[14px] place-items-center">
            ...
            <div className="w-full grid place-items-center mt-10 lg:mt-0 lg:px-10">
              <ResetPasswordConfirmationForm type="phone" />
            </div>
          </div>
        </div>
      </div>
...
export default ResetPasswordConfirmationPhone;
