          ...
          <div className="col-start-1 col-span-8 min-[640px]:col-start-2 min-[640px]:col-span-6 min-[1024px]:col-start-3 min-[1024px]:col-end-7 min-[1024px]:col-span-2 ">
            <div className="max-w-xl mx-auto bg-none bg-opacity-0">
              <div className={`rounded-lg py-10 ${isDesktop ? "px-12 w-[42rem]" : "px-7 w-full"}`}>
                ...
                />
                  <h2 className={`font-semibold font-custom text-[#000000] leading-[45px] ${isDesktop ? "text-[38px]" : "text-[22px]"}`}>Get started</h2>
                </div>
                <form onSubmit={onSubmitHandler}>
                  ...
                  <button
                    ...
                    required
                  >
                    <span>{pending ? "Request processing..." : "Sign up"}</span>
                  </button>
                </form>
                <p className="text-center pt-5 text-sm">
                  <span className="text-[#969BA5] leading-5 text-[14px] font-custom font-medium">Already have an account? ?</span>{" "}
                  <Link to="/login" className="text-purple-primary underline">
